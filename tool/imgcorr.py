...
def imgcorr(src):
    ...
    Cannyimg = cv2.Canny(blurimg, 100, 400)
    cv2.imwrite("/Users/wywy/Desktop/图片矫正/output1.jpg", Cannyimg)

    lines = cv2.HoughLinesP(Cannyimg, 1, np.pi / 180, threshold=60, minLineLength=100, maxLineGap=100)
...
if __name__ == '__main__':
    # src=Image.open("/Users/wywy/Desktop/图片矫正/input.jpg")
    # src=src.resize((1080,1440))
    # src=np.array(src)

    src = cv2.imread("/Users/wywy/Desktop/图片矫正/11.jpg")
    dst = imgcorr(src)
    # cv2.imshow("Image", dst)
    # cv2.waitKey(0)
    cv2.imwrite("/Users/wywy/Desktop/图片矫正/output.jpg", dst)