...
testimg_path = "/Users/wywy/Desktop/手写判断题数据/cls_test"
...
def test_shuffle_batch(train_file_path, image_size, batch_size, capacity=7000, num_threads=3):
    ...
    images_, setoff_lables_, file_name_ = tf.train.shuffle_batch([images, setoff_lables, file_name],
...
if __name__ == '__main__':
    ...
    saver_lables(testimg_path, test_filename, (64, 64))
